...
package Goo::Thing::pm::ProgramCompiler;
...
# Filename:     Goo::Thing::pm::ProgramCompiler.pm
...
Goo::Thing::pm::ProgramCompiler - Compile a Perl program

=head1 SYNOPSIS

use Goo::Thing::pm::ProgramCompiler;
